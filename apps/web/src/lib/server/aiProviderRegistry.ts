...
export const AI_PROVIDER_REGISTRY: readonly AiProviderDefinition[] = [
  ...
  { id: "openai", name: "OpenAI", kind: "openai-compatible", auth: "api_key", endpoint: "https://api.openai.com/v1", modelsEndpoint: "https://api.openai.com/v1/models", capabilities: chatVision },
  ...
  { id: "xai", name: "xAI", kind: "openai-compatible", auth: "api_key", endpoint: "https://api.x.ai/v1", modelsEndpoint: "https://api.x.ai/v1/models", capabilities: chatVisionResearch },
  ...
  { id: "openai-codex", name: "OpenAI Codex OAuth", kind: "native", auth: "oauth", capabilities: chat },
