...
- Agent and engineering workflow docs live in `dev/` (changelog guide, dev server,
  security, templates, MCP, etc.).
- Root-level exceptions: `README.md`, `CHANGELOG.md`, `CONTRIBUTING.md`, `AGENTS.md`,
  `TODO.md`, `LICENSE`.
